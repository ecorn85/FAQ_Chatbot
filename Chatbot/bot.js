...
const jFile = "../Shared_Resources/FAQ.json";
...
function onMessageHandler (target, context, msg, self) {
  ...
  for(let question of FAQ.questions){
    ...
    if(question.isActive && currentTime - question.timestamp > (question.frequencyInSec * 1000)){
      let match = false;
      ...
      if(match){
        client.say(target, `@${context.username} ${question.reply}`);
